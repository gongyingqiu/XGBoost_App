                          ...
                          tabsetPanel(type = "tabs",
                                      ...
                                      tabPanel("Data Spec",
                                               ...
                                               fluidRow(
                                                 ...
                                                 column(4,
                                                        ...
                                                        actionButton("action_prepare_data", "Prepare data",class='btn-primary',width = '50%'),
                                      ...
                                      tabPanel("Data manipulation",
                                               ...
                                               fluidRow(
                                                 ...
                                                 column(3, offset = 4,
                                                        br(),
                                                        actionButton("action_modify_factor", "Change current factor mapping",class='btn-primary',width = '80%')
                                                 ),
                                               ...
                                               fluidRow(
                                                 column(7,
                                                        plotlyOutput("Actual_plot", height = 600),
                                                 ...
                                                 column(4,
                                                        ...
                                                        fluidRow(
                                                          column(4,
                                                                 actionButton("Modify", 
                                                                              "Confirm current mapping",class='btn-primary'),
                                               ...
                                               actionButton("Prepare_modelling_data", 
                                                            "Create modelling dataset",class='btn-primary',width = '45%',style='padding:4px; font-size:80%'),
...
server <- function(input, output, session) {
  ...
  observeEvent(input$action_modify_factor, {
    ...
    rv$factor_lookup_tb_orig <- data.frame(current_factor_level = rv$actual_summary_lst[[input$FactorSelect_oneway]][['factor_name']], 
                                           new_factor_level = rv$actual_summary_lst[[input$FactorSelect_oneway]][['factor_name']])
  ...
  output$factor_mapping_table <- DT::renderDataTable(server = FALSE,{
    DT::datatable(rv$factor_lookup_tb,rownames = FALSE,editable = TRUE,
  ...
  observeEvent(input$Modify, {
    for(sample in as.numeric(c(1,2,3))) {
      rv$subset_data[[sample]][[input$FactorSelect_oneway]] <-  with(rv$factor_lookup_tb,
                                                                     new_factor_level[match(rv$subset_data[[sample]][[input$FactorSelect_oneway]],
